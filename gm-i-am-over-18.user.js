...
(function() {
    ...
    switch (domain) {
        ...
        case 'assoass.com':
        case 'blacked.com': {
            const enterBtn = document.querySelector('button[data-test-component="AgeVerificationEnterButton"]');
